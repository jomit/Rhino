    ...
    INDIGOSLATE.adminViewHelper = (function () {
        ...
        function showErrorMessage(message) {
            if (message == undefined || message == '') {
                message = "Something went bonkers. Can you please try 1 more time..";
            }
            swal({
                title: "This sucks !!",
                text: message,
        ...
        function showSuccessMessage(message) {
            if (message == undefined || message == '') {
                message = "Got the data. Had to put it in the approval queue (Boss needs to see it before anyone else).";
            }
            swal({
                title: "WooHoo !!",
                text: message,
